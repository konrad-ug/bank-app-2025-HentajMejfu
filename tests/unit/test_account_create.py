...
class TestPersonalAccount:
    ...
    @pytest.mark.parametrize("name, surname, pesel", [
    ...
    @pytest.mark.parametrize("name, surname, pesel, promo_code, expected_balance", [
    ...
    def test_promo(self, name: str, surname: str, pesel: str, promo_code: str, expected_balance: float):
        acc: PersonalAccount = PersonalAccount(name, surname, pesel, promo_code)
        assert acc.balance == expected_balance


    @pytest.mark.parametrize("name, surname, pesel, promo_code, expected_result", [
    ...
    def test_validate_promo_correct(self, name: str, surname: str, pesel: str, promo_code: str, expected_result: bool):
        acc: PersonalAccount = PersonalAccount(name, surname, pesel, promo_code)
...
class TestBusinessAccount:
    ...
    @pytest.mark.parametrize("company_name, nip", [
