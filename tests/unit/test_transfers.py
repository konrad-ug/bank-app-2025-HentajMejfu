...
class TestPersonalTransfers:
    def test_normal_transfer_enough(self):
        acc: PersonalAccount = PersonalAccount("Ewa", "Karp", "12345678901", "PROM_420")
        assert acc.normalTransfer(20) is True
        assert acc.history == [-20]

    def test_normal_transfer_not_enough(self):
        acc: PersonalAccount = PersonalAccount("Pawel", "Malinowski", "12345678901", "PROM_4200")
        assert acc.normalTransfer(20) is False


    def test_express_transfer_enough(self):
        acc: PersonalAccount = PersonalAccount("Tomasz", "Buczkowicz", "12345678901", "PROM_420")
    ...
    def test_express_transfer_not_enough(self):
        acc: PersonalAccount = PersonalAccount("Maciej", "Niedzwiedz", "12345678901", "PROM_420")
